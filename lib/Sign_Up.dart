    ...
    if (!_isNotValidateemail &&
      ...
      if (jsonResponse['status']) {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => CategoryScreen(emailController.text)));
      } else {
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              const Text("I promise that I won't kidnap anyone", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w300),),
                            ],
                          ),
                          const SizedBox(
                            height: 140,
